          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <a href="mailto:support@raahi.travel" className="text-primary font-medium">support@raahi.travel</a>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600 mb-4">Available Mon-Sat, 9 AM to 6 PM IST</p>
                <a href="tel:+910000000000" className="text-primary font-medium">+91 000 000 0000</a>
              </div>
